...
data = pd.read_csv("第二问数据集/低级机器设备.csv", index_col=0)
...
# 保存模型
# joblib.dump(dtc,'model_2_low_dt.pkl')
...
# 保存模型
joblib.dump(rfc, '模型保存/save_model(问题二RF低级).pkl')
...
plt.title('低级机器二分类rf测试集混淆矩阵可视化', fontsize=12)
