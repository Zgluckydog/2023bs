...
data = pd.read_csv(r"第二问数据集/中级机器设备.csv")
...
# 保存模型
# joblib.dump(dtc,'model_2_mid_dt.pkl')
...
# 保存模型
joblib.dump(rfc, '模型保存/save_model(问题二RF中级).pkl')
...
plt.title('中级机器二分类rf测试集混淆矩阵可视化', fontsize=12)
